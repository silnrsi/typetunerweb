...
Please send us your requests using the [form on the font website](https://software.sil.org/scheherazade/about/contact/). If you are interested in helping us make the font better see the [Developer](developer.md) page.
