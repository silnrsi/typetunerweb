...
Andika Basics is a small subset of our Andika font which supports 
...
supported. Documentation for Andika Basics is available on the
Andika Basics website (http://scripts.sil.org/Andika_Basics).
